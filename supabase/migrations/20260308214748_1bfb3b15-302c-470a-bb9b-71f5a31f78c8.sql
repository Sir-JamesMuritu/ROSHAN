...
INSERT INTO public.testimonials (name, role, program, rating, text) VALUES
  ('Grace Mwangi', 'Data Analyst at Safaricom', 'Data Analytics Professional', 5, 'RTIcompletely transformed my career. I went from knowing nothing about data to landing a job as a data analyst within 3 months of completing the program.'),
  ...
  ('David Kimani', 'Junior Developer at KCB', 'SQL & Database Management', 5, 'I was struggling with databases before RTI. Now I write complex SQL queries confidently and even mentor others. Best investment I''ve made in myself.');
